# STAKEHOLDERS.md — ZakaWise: Stakeholder Analysis

## Overview

This document identifies and analyses all key stakeholders for the ZakaWise Personal Finance Management System. Each stakeholder's role, concerns, pain points, and success metrics are documented to ensure the system addresses real-world needs.

## Stakeholder Analysis Table
| # | Stakeholder            | Role                                      | Key Concerns                                      | Pain Points                                      | Success Metrics                                      |
|---|------------------------|-------------------------------------------|--------------------------------------------------|--------------------------------------------------|------------------------------------------------------|
| 1 | Registered User        | Primary end-user managing finances        | Real-time tracking, dashboards, savings progress | No central system, manual tracking errors        | View balance in ≤3s, reduce tracking time by 50%     |
